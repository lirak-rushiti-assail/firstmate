...
FM_DASHBOARD_TODO=10         # fleet-wide queued rows (this home's structured backlog plus each structured secondmate home's queued inventory) the bin/fm-dashboard.sh Todo column shows before disclosing the rest
